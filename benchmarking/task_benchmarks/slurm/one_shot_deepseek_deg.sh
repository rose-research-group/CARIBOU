#!/bin/bash
#SBATCH --job-name=deg_one_shot_deepseek
...
mkdir -p "$LOG_DIR"
LOG_PATH="$LOG_DIR/one_shot_deepseek_deg_${SLURM_JOB_ID}_${SLURM_ARRAY_TASK_ID:-0}.log"
exec > "$LOG_PATH" 2>&1
...
OUTPUT_BASE="$ROOT_DIR/benchmarking/task_benchmarks/results/deg_task/one_shot"
