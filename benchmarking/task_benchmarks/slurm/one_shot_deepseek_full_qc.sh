#!/bin/bash
#SBATCH --job-name=full_qc_one_shot_deepseek
...
mkdir -p "$LOG_DIR"
LOG_PATH="$LOG_DIR/one_shot_deepseek_full_qc_${SLURM_JOB_ID}_${SLURM_ARRAY_TASK_ID:-0}.log"
exec > "$LOG_PATH" 2>&1
...
OUTPUT_BASE="$ROOT_DIR/benchmarking/task_benchmarks/results/full_qc_task/one_shot"
...
for trial in $(seq 1 "$NUM_TRIALS"); do
    echo "================================================================================"
    echo "Starting One-Shot full_qc Trial $trial of $NUM_TRIALS"
...
echo "All one-shot full_qc trials complete"
