#!/bin/bash
#SBATCH --job-name=data_adequacy_one_shot_deepseek
...
mkdir -p "$LOG_DIR"
LOG_PATH="$LOG_DIR/one_shot_deepseek_data_adequacy_${SLURM_JOB_ID}_${SLURM_ARRAY_TASK_ID:-0}.log"
exec > "$LOG_PATH" 2>&1
...
OUTPUT_BASE="$ROOT_DIR/benchmarking/task_benchmarks/results/data_adequacy_task/one_shot"
