#!/bin/bash
#SBATCH --job-name=full_qc_full_system_deepseek
...
mkdir -p "$LOG_DIR"
LOG_PATH="$LOG_DIR/full_system_deepseek_full_qc_${SLURM_JOB_ID}_${SLURM_ARRAY_TASK_ID:-0}.log"
exec > "$LOG_PATH" 2>&1
...
OUTPUT_BASE="$ROOT_DIR/benchmarking/task_benchmarks/results/full_qc_task/full_system"
...
for trial in $(seq 1 "$NUM_TRIALS"); do
    echo "================================================================================"
    echo "Starting Full System full_qc Trial $trial of $NUM_TRIALS"
...
echo "All full-system full_qc trials complete"
