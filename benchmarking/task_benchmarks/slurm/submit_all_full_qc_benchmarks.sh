...
echo "Submitting full_qc Benchmark Jobs..."
...
sbatch --chdir "$ROOT_DIR" "$SLURM_DIR/single_agent_claude_full_qc.sh"
...
sbatch --chdir "$ROOT_DIR" "$SLURM_DIR/full_system_claude_full_qc.sh"
