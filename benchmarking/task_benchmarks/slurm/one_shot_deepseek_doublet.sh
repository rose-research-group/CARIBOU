#!/bin/bash
#SBATCH --job-name=doublet_one_shot_deepseek
...
mkdir -p "$LOG_DIR"
LOG_PATH="$LOG_DIR/one_shot_deepseek_doublet_${SLURM_JOB_ID}_${SLURM_ARRAY_TASK_ID:-0}.log"
exec > "$LOG_PATH" 2>&1
...
for trial in $(seq 1 "$NUM_TRIALS"); do
    echo "================================================================================"
    echo "Starting One-Shot doublet Trial $trial of $NUM_TRIALS"
...
echo "All one-shot doublet trials complete"
