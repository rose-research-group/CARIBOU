...
echo "Submitting doublet Benchmark Jobs..."
...
sbatch --chdir "$ROOT_DIR" "$SLURM_DIR/single_agent_claude_doublet.sh"
...
sbatch --chdir "$ROOT_DIR" "$SLURM_DIR/full_system_claude_doublet.sh"
